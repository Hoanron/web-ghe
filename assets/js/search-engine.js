...
//   var menuToggleUserBtn = document.querySelector(".menuToggleuser");
//   var menuToggleContent = document.querySelector(".menu-toggle");

//   console.log('menuToggleUserBtn:', menuToggleUserBtn); // Check if the element is found

//   if(menuToggleBtn) {
//     menuToggleBtn.onclick = function(){
//       console.log('menuToggleuser clicked'); // Debugging line
//       menuToggleContent.classList.toggle('active');
//     }
//   }

//   if(menuToggleUserBtn) {
//     menuToggleUserBtn.onclick = function(){
//       console.log('menuToggleuser clicked'); // Debugging line
//       menuToggleUserBtn.classList.toggle('active');
//       menuToggleContent.classList.toggle('active');
//     }
//   }
// });
