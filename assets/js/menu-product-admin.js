...
function renderDetailsOrder(idCurrentOrderForm) {
  ...
  <div id="orderDetailContainer-content" onclick="stopPropagating(event)">
    ...
    <div class="orderDetailContainer-content-list-products">
      <div class="orderDetailContainer-content-product">
        <div class="view-order-container-bottom-product-img">
          <img src="./assets/img/70979306a536cfd53f1ca349577fd719.jpg.webp" alt="">
        </div>
        ...
        <div class="view-order-container-bottom-product-quantity">
          x<input type="number" value="1" class="view-order-container-bottom-product-quantity-adjust" disabled>
        </div>
        <div class="view-order-container-bottom-product-price">
          <span class="view-order-container-bottom-product-priceNumber">870.000</span>
      ...
      <div class="orderDetailContainer-content-product">
        <div class="view-order-container-bottom-product-img">
          <img src="./assets/img/chuot-khong-day-dareu-lm115g-01-768x768.jpg" alt="">
        </div>
        <div class="view-order-container-bottom-product-name">
          <div class="view-order-container-bottom-product-name-title">
            Chuột không dây
        ...
        <div class="view-order-container-bottom-product-price">
          <span class="view-order-container-bottom-product-priceNumber">125.000</span>
          <span class="view-order-container-bottom-product-priceIcon">₫</span>
        </div>
      </div>
    </div>
    ...
    <div class="view-order-container-bottom-product-detail orderDetailContainer-content-total">
      <div class="view-order-container-bottom-product-detail-total-title">Tình trạng : <span style="color:green;">Đã xác nhận</span></div>
      <div class="view-order-container-bottom-product-detail-total">
        ...
        <div class="view-order-container-bottom-product-detail-total-money">995.000</div>
  ...
  for(let i = 0; i < orderForm.length; i++)
  {
    if(orderForm[i].idOrderForm == orderId)
    {
      ...
      else
      {
        ...
        orderStatus[i].innerHTML = `
        Đã xác nhận
        <input type="checkbox" checked class="status" onclick="preventCheckboxToggle(${orderForm[i].idOrderForm})">
      `
        console.log("đã xác nhận");
        alert("Đơn hàng có mã " + orderForm[i].idOrderForm + " đã được xác nhận!");
      }
...
function renderOrder(orderArray) {
  ...
  <div class="header">
    ...
    <div class="order-product">CHI TIẾT ĐƠN HÀNG</div>
  </div>
