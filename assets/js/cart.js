...
function showPurchasedProducts() {
  document.getElementById('purchased-products').style.display = 'block';
}

function hidePurchasedProducts() {
  document.getElementById('purchased-products').style.display = 'none';
}

// Thêm vào các event listeners hiện tại
document.addEventListener('DOMContentLoaded', function() {
  // ... existing code ...
  
  // Close purchased products when clicking outside
  document.getElementById('purchased-products').addEventListener('click', function(e) {
    if (e.target === this) {
      hidePurchasedProducts();
    }
  });
});
